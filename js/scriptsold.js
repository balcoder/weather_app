...
// xmlhttp.open("GET", "http://api.openweathermap.org/data/2.5/weather?lat="+ latitude.toString()+"&lon="+longitude.toString()+"&units=metric&APPID=a97ac8512b855c7a557f17fa8b10d4da", true);
